...
const CartPage = () => {
  ...
  const {cart, totalQuantity, totalPrice} =   useSelector((state:any) => state.allCart)
                ...
                cart.map((data:any) => {
                    ...
                    <div className="col-lg-5 col-md-6 mb-4 mb-lg-0">
                      ...
                      <button  type="button" data-mdb-button-init data-mdb-ripple-init className="btn btn-primary btn-sm me-1 mb-2" data-mdb-tooltip-init
                        title="Remove item" onClick={() => dispatch(removeItem(data))}>
                    ...
                    <div className="col-lg-4 col-md-6 mb-4 mb-lg-0">
                      ...
                      <div className="d-flex mb-4" style={{maxWidth: '300px'}}>
                        <button data-mdb-button-init data-mdb-ripple-init className="btn btn-primary px-3 me-2" onClick={() => dispatch(decreaseItemQuantity(data.id))}>
